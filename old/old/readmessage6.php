...
function testdisplay()
{
		...
		for (i=0; i<level1rows; i++)
		{
			...
			msg=message.replyby[i].message;
				...
				//<div id="demo" class="collapse">				 	
//				<textarea class="form-control" rows="11" id="replymessage"></textarea>					
			dividstart='<div id="demo'+i+'" class="collapse">';
			...
			pstart='<p style="background-color:tomato; border-width: 1px;border-color:grey;border-style: solid;">';
			//This is a paragraph.
			pend='</p>';
			msg=pstart+msg+pend;
			
			msgstr=headerstr+msg+tailstr+headerstr+replyhrefstart+
			
			
			replyicon+ replyhrefend+newline+replyinner+newline;	
			...
			for (j=0; j<level2rows; j++)
			{
					...
					msgstr=headerstr+msg+tailstr+headerstr+replyicon+" Reply"+newline+newline;
					...
					for (k=0; k<level3rows; k++)
					{
						...
						msgstr=headerstr+msg+tailstr+headerstr+replyicon+newline+newline;	
						finalmsgstr+=msgstr;							
...
//				<textarea class="form-control" rows="11" id="replymessage"></textarea>					
			...
			pstart='<p style="background-color:#FCFCFC;  ">';
			//This is a paragraph.
			pend='</p>';
			msg=pstart+msg+pend;			
			msgstr=headerstr+msg+tailstr+headerstr+replyhrefstart+
...
var testlongstr="";
function testrecursivedisplay(message)
{
		var finalmsgstr="";
		header='<p style="margin-left:  ';
...
//				<textarea class="form-control" rows="11" id="replymessage"></textarea>					
			...
			for (j=0; j<level2rows; j++)
			{
					mk=message.replyby[i];
					testrecursivedisplay(mk);
               ...
               replyby: [
                 {
				   ...
				   timestamp:"222234567",
                    replyby: [
                      ...
                      {
						   message:"This is a 2nd message from L5",
	   ...
	   },
	   {
		  ...
		  replyby:[
		  
                     {
                      ...
                      {
						   message:"This is a 2nd message from L3",
						   senderAddress:"ZIL111333334567",
						   timestamp:"22223554567",
							replyby:[]						   
                      }  		  
...
var glongmessage="";
 ...
 function findreplymessagebytxid(txid) {
		urlstr="getsearchmessagebytxid3.php?txid="+txid;
		console.log(urlstr);		   
        $.ajax({
  ...
  function findreplymessagebytxidOri(txid) {
