...
async function readmsgfromblockhain(txid, num)
{
	 ...
	 //document.getElementById("txid"+num).innerHTML="Message #"+num+" txid: "+txid;
	  ...
	  newtab=' target="_blank" rel="noopener noreferrer"';			
			...
			url1="https://myzilliqawallet.com/readmessage.php?txid="+txid;
			myzilliqawalletlink='<a href="'+url1+'"'+newtab+'>'+ txid + '</a>';
			
			
			 
	 orimsg="Message #"+num+" txid: 0x"+myzilliqawalletlink;
	 newline="<br>";
	 senderinfo="Sender :"+senderAddr;
	 newmsg=orimsg+newline+senderinfo;
	 
	 
	 document.getElementById("txid"+num).innerHTML=newmsg;
