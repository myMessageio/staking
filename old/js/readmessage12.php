		...
		<h5>	<small>	  		  
		  ...
		  <div class="col-6"> 
				...
				<textarea class="form-control" rows="11" id="replymessage"></textarea>					 
					 ...
					 <br>
					 <button type="button" class="btn btn-primary btn-sm    btn-block" id="replymessageid" onclick="replymessage()"   disabled  >Reply Message</button> 					 
					 <br>
...
async function readmsgfromblockhain(txid)
{
	 ...
	 flagdigit1= str.charAt(2);
	 flagdigit2= str.charAt(3);	 
	 flagdigit3= str.charAt(4);
