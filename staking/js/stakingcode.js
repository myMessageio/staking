...
var myContractAddress='0xeb2756a6C387FF0060049525eaAd6C222e3d6B0C'; // staking V5 mainnet
////////////////////////new
var rewardtokenaddress="0xb192d5fC358D35194282a1a06814aba006198010"; // real busd in mainnet
 
var rewardsymbol="MESA";
...
//	var totalburnamount=await getWalletBalancePLUT('0x000000000000000000000000000000000000dEaD');
  ...
  //	usermaturitydate3 = await getMaturityDate(2);	
	...
	var userinfo1="<b>Jellybean Pool </b><br>You have staked "+userstakedamountpool1+" MESA <br>Your reward is "+usertotalreward1+" MESA <br>Maturity date: "+usermaturitydate1+" <br><br>" 
 	...
 	document.getElementById("pool1stakedamount").innerHTML=userstakedamountpool1+" MESA"  ;
 	document.getElementById("pool1rewardamount").innerHTML=usertotalreward1+" MESA"  ;	
	...
	var userwalletinfo="<b>Your Wallet</b><br>"+defaultwalletaddress+"<br>You have "+userwalletplutbalance+" MESA and "+userwalletbnbbalance+" BNB ";
...
//  
	...
	var tokensleft=50000000000-poolfilledamount1;
	...
	var tokensleft=50000000000-poolfilledamount2;
	tokensleft=properdecimal(tokensleft, 2);	
