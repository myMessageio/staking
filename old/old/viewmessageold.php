...
<div class="bs-1">
 ...
 <hr>
  ...
  <p id="messagenum1">Message #1  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid1">  </p>
			  <p id="senderaddress1">  </p>		 
			  <p id="contractaddress1">  </p>		 
			  <p id="blocknum1">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum2">Message #2  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid2">  </p>
			  <p id="senderaddress2">  </p>		 
			  <p id="contractaddress2">  </p>		 
			  <p id="blocknum2">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum3">Message #3  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid3">  </p>
			  <p id="senderaddress3">  </p>		 
			  <p id="contractaddress3">  </p>		 
			  <p id="blocknum3">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum4">Message #4  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid4">  </p>
			  <p id="senderaddress4">  </p>		 
			  <p id="contractaddress4">  </p>		 
			  <p id="blocknum4">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum5">Message #5  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid5">  </p>
			  <p id="senderaddress5">  </p>		 
			  <p id="contractaddress5">  </p>		 
			  <p id="blocknum5">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum6">Message #6  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid6">  </p>
			  <p id="senderaddress6">  </p>		 
			  <p id="contractaddress6">  </p>		 
			  <p id="blocknum6">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum7">Message #7  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid7">  </p>
			  <p id="senderaddress7">  </p>		 
			  <p id="contractaddress7">  </p>		 
			  <p id="blocknum7">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum8">Message #8  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid8">  </p>
			  <p id="senderaddress8">  </p>		 
			  <p id="contractaddress8">  </p>		 
			  <p id="blocknum8">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum9">Message #9  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid9">  </p>
			  <p id="senderaddress9">  </p>		 
			  <p id="contractaddress9">  </p>		 
			  <p id="blocknum9">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
  ...
  <p id="messagenum10">Message #10  </p> 
  <div class="row">
		  <div class="col-sm-4">	        
			  <hr><hr>
			  <h5 style="word-break: break-word;">	<small>	  		  
			  <p id="txid10">  </p>
			  <p id="senderaddress10">  </p>		 
			  <p id="contractaddress10">  </p>		 
			  <p id="blocknum10">  </p>				 
			  </h5></small> 		  
			  <hr>
			  <hr> 	 
...
async function readmsgfromblockhain(txid, num)
{
	 ...
	 document.getElementById("txid"+num).innerHTML="TXid: "+txid;
