...
var myContractAddress='0x59644639e9ED146515d380422B43b816F12a6e7a'; // staking V5 mainnet
////////////////////////new
...
document.getElementById("currentplutpriceid").innerHTML='Current PLUT price= '+data['plutos-network']['usd']+' USD'
...
const getBUSDPrice = async event => {
 
//console.log('getHistoricalPrice');

let string="https://api.coingecko.com/api/v3/simple/price?ids=polkacipher&vs_currencies=usd";

await fetch(string)
.then(resp => resp.json())
.then(data => document.getElementById("currentpolkacipherpriceid").innerHTML='Current CPHR price= '+data['polkacipher']['usd']+' USD')
...
//if (stakeid=="oreo") 	 	poolnum=0;
 ...
 if (stakeid=="jellybean") 	    poolnum=0;
  if (stakeid=="marshmallow") 	 	poolnum=1; 
...
//	var totalburnamount=await getWalletBalancePLUT('0x000000000000000000000000000000000000dEaD');
  ...
  //	usermaturitydate3 = await getMaturityDate(2);	
	...
	var userinfo1="<b>Jellybean Pool </b><br>You have staked "+userstakedamountpool1+" PLUT <br>Your reward is "+usertotalreward1+" PLUT <br>Maturity date: "+usermaturitydate1+" <br><br>" 
				 
	document.getElementById("userpoolinfo1").innerHTML=userinfo1  ;


	var userinfo1="<b>Marshmallow Pool </b><br>You have staked "+userstakedamountpool2+" PLUT <br>Your reward is "+usertotalreward1+" PLUT <br>Maturity date: "+usermaturitydate2+" <br><br>" 
	...
	var userwalletinfo="<b>Your Wallet</b><br>"+defaultwalletaddress+"<br>You have "+userwalletplutbalance+" PLUT and "+userwalletbnbbalance+" BNB ";
...
//  
	...
	var tokensleft=2000000-poolfilledamount1;
	tokensleft=properdecimal(tokensleft, 2);	
	
	document.getElementById("tokensleftid1").innerHTML="Amount available to stake: "+tokensleft+" PLUT";

    pool1filledpercent1=Math.round(poolfilledamount1/2000000*100.0);   //poolfilledamount1 is oreo
	
	
	var tokensleft=2000000-poolfilledamount2;
	tokensleft=properdecimal(tokensleft, 2);	
	
	document.getElementById("tokensleftid2").innerHTML="Amount available to stake: "+tokensleft+" PLUT";
