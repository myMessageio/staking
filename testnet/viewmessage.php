<?php
  ...
  $currentpagestr='<a href="viewmessage.php?page='.$page.'"   style="vertical-align: middle;" >'.$page.'</a>';  
  ...
  $navigation= "$firstpagestr $previouspagestr  $currentpagestr  $nextpagestr $lastpagestr";
...
async function readmsgfromblockhain(txid, num)
{
	 ...
	 //document.getElementById("txid"+num).innerHTML="Message #"+num+" txid: "+txid;
	  ...
	  newtab=' target="_blank" rel="noopener noreferrer"';			
			...
			url1="readmessage.php?txid="+txid;			
...
function viewpage()
{
	...
	window.location.replace("viewmessage.php?page="+pagenum);
}	
